...
import { List, ListItemButton, ListItemText, Collapse, Drawer, Toolbar, IconButton, Typography } from '@mui/material';
import MenuIcon from '@mui/icons-material/Menu';
import { ExpandLess, ExpandMore } from '@mui/icons-material';
import { useSelection } from '../hooks/useSelection';

const ResponsiveNavigation = ({ data }) => { // 'data' is your nested API response
  const [openCountry, setOpenCountry] = useState(null);
  const [openLocation, setOpenLocation] = useState(null);
  const { setSelection, drawerOpen, setDrawerOpen } = useSelection();
